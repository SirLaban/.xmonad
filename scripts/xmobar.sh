...
echo -n "<fc=#aaaaaa>cpu:</fc> <fc=#eeeeee>"
...
echo -n "</fc> <fc=#dd0000>|</fc> <fc=#aaaaaa>ip:</fc> <fc=#eeeeee>$( ~/.xmonad/scripts/if_ip.sh )</fc>"
...
echo -n "</fc> <fc=#dd0000>|</fc> <fc=#aaaaaa>bat:</fc> <fc=#eeeeee>$( ~/.xmonad/scripts/battery.sh )</fc>"
